...
export const fetchCategoriesById = (categoryId) => async (dispatch) => {
  ...
  try {
    ...
    const response = await get(
      `${API_ENDPOINTS.COMMON.GET_CATEGORIES}/${categoryId}`
    )


    // Check if the category is found
    if (response.message === 'CATEGORY_FOUND' && response.success === true) {
